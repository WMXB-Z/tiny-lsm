...
public:
    MockWAL(const std::string& log_path, size_t buffer_size,
            uint64_t max_flushed_seq)
        : WAL(log_path, buffer_size, max_flushed_seq, 1, 100) {}
    ...
    void set_max_flushed_seq(uint64_t max_flushed_seq) {
        max_flushed_seq_ = max_flushed_seq;
    }

    uint64_t get_max_flushed_seq() { return max_flushed_seq_; }
};
